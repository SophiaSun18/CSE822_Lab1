    ...
    for (uint64_t i = 0; i < img_size; i++) {
        for (uint64_t j = 0; j < img_size; j+=vector_size) {
            ...
            __m512 cx = _mm512_set_ps(
                float(j + 15) / float(img_size) * 2.5f - 2.0f, float(j + 14) / float(img_size) * 2.5f - 2.0f,
                float(j + 13) / float(img_size) * 2.5f - 2.0f, float(j + 12) / float(img_size) * 2.5f - 2.0f,
                float(j + 11) / float(img_size) * 2.5f - 2.0f, float(j + 10) / float(img_size) * 2.5f - 2.0f,
                float(j + 9) / float(img_size) * 2.5f - 2.0f, float(j + 8) / float(img_size) * 2.5f - 2.0f,
                float(j + 7) / float(img_size) * 2.5f - 2.0f, float(j + 6) / float(img_size) * 2.5f - 2.0f,
                float(j + 5) / float(img_size) * 2.5f - 2.0f, float(j + 4) / float(img_size) * 2.5f - 2.0f,
                float(j + 3) / float(img_size) * 2.5f - 2.0f, float(j + 2) / float(img_size) * 2.5f - 2.0f,
                float(j + 1) / float(img_size) * 2.5f - 2.0f, float(j) / float(img_size) * 2.5f - 2.0f);
            ...
            __m512 r_4 = _mm512_set1_ps(4.0f);

            for (int i = 0; i < max_iters && active != 0; i++) {
